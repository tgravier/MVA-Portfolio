...
output_file = "dataset/file_paths_test.txt"
        ...
        if os.path.isdir(folder_path):
            ...
            for file_name in os.listdir(folder_path):
                if "mix_snr" in file_name:
                    ...
                    voice_path = os.path.join(root_dir , folder, file_name)
                elif "noise" in file_name:
                    noise_path = os.path.join(root_dir , folder, file_name)
                    
            # Ensure all paths are found before writing to the file
            if mix_path and voice_path and noise_path:
                f.write(f"{mix_path} {voice_path} {noise_path}\n")
